...
var Hx = $hx_exports["Hx"] = function() { };
$hxClasses["Hx"] = Hx;
Hx.__name__ = "Hx";
Hx.main = function() {
};
Hx.Serialize = function(v) {
	return haxe_Serializer.run(v);
};
Hx.Unserialize = function(v) {
	return haxe_Unserializer.run(v);
};
